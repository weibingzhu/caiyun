<template>
  <div id="App">
    <router-view v-if="$route.meta && $route.meta.other"></router-view>
    <ms-frame-layout v-else title="后台管理系统" :menus="menus" class="home-index" :asideCollapse="asideCollapse" ref="frameLayout">
  ...
  methods: {
    ...
    handleClickLogo () {
      ...
      this.isDbClick = setTimeout(() => {
        this.$refs.frameLayout.isCollapse = !this.$refs.frameLayout.isCollapse
      }, 300) // 大概时间300ms
    },
