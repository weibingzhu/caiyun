    ...
    <e-page-list-layout>
      ...
      <template slot="search">
        <el-button-group class="all-module" style="display:flex; padding: 10px">
          <el-badge :value="12" class="item"><el-button class="width: 100%" ref="btnPurchase" size="small" @click="handleClickModule('purchase')">进项</el-button></el-badge>
          <el-badge :value="12" class="item"><el-button class="w-100" ref="btnSales" size="small" @click="handleClickModule('sales')">销项</el-button></el-badge>
          <el-badge :value="12" class="item"><el-button class="w-100" ref="btnBank" size="small">银行对账单</el-button> </el-badge>
          <el-badge :value="12" class="item"><el-button class="w-100" ref="btnPayroll" size="small">工资</el-button></el-badge>
          <el-badge :value="12" class="item"><el-button class="w-100" ref="btnPurchaseCustoms" size="small">海关缴款书</el-button></el-badge>
          <el-badge :value="12" class="item"><el-button class="w-100" ref="btnSalesCustoms" size="small">海关报关单</el-button> </el-badge>
          <el-badge :value="12" class="item"><el-button class="w-100" ref="btnCharge" size="small">费用</el-button></el-badge>
          <el-badge :value="12" class="item"> <el-button class="w-100" ref="btnFixedAsset" size="small">固定资产</el-button></el-badge>
          <el-badge :value="12" class="item"><el-button class="w-100" ref="btnManualBil" size="small">手工票据</el-button></el-badge>
          <el-badge :value="12" class="item"> <el-button class="w-100" ref="btnTicket" size="small">银行承兑汇票</el-button> </el-badge>
        </el-button-group>
        <div class="status-list" v-if="isShowCrawlerList" style="padding: 0 12px">
          <div style="text-align: end;"><el-link type="primary" style="padding: 0 4px">更多 </el-link></div>
          <el-table style="width: 100%"
            highlight-current-row
            :row-style="{padding:'2px 0'}"
            :data="showCrawlerListData">
