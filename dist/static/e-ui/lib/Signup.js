...
// CONCATENATED MODULE: ./node_modules/_vue-loader@15.7.2@vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/_vue-loader@15.7.2@vue-loader/lib??vue-loader-options!./src/components/signup/index.vue?vue&type=template&id=679277ab&
var render = function() {
  var _vm = this
    ...
    [
      _c(
        ...
        [
          ...
          _c(
            "el-form-item",
            { attrs: { prop: "password", rules: _vm.passwordRules } },
            [
              _c(
                "e-password",
                _vm._b(
          ...
          _vm.errorMessage
            ? _c(
                "div",
                { staticClass: "el-form-item__error e-signup-error" },
                [
                  _c("el-alert", {
                    attrs: {
                      closable: false,
      ...
      _vm.$slots.links
        ? _c("div", { staticClass: "e-signup-links" }, [_vm._t("links")], 2)
        : _vm._e()
    ],
    1
  )
...
// CONCATENATED MODULE: ./src/components/signup/index.vue?vue&type=template&id=679277ab&
...
// CONCATENATED MODULE: ./node_modules/_babel-loader@7.1.5@babel-loader/lib!./node_modules/_vue-loader@15.7.2@vue-loader/lib??vue-loader-options!./src/components/signup/index.vue?vue&type=script&lang=js&
...
/* harmony default export */ var signupvue_type_script_lang_js_ = ({
  ...
  props: {
    ...
    passwordRules: {
      type: Array,
      default: function _default() {
        return [{ required: true, message: '请设置密码' }, { min: 6, message: '密码不能小于6个字符' }, { pattern: /^[a-zA-Z0-9_]+$/, message: '密码格式不正确,必须是数字或者字母' }];
      }
    },
    submitText: {
      type: String,
...
// CONCATENATED MODULE: ./src/components/signup/index.vue?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./src/components/signup/index.vue
...
/* hot reload */
if (false) { var api; }
component.options.__file = "src/components/signup/index.vue"
